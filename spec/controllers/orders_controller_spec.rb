...
describe OrdersController do
  ...
  let(:valid_attributes) { { "contract_number" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved order as @order" do
        ...
        post :create, {:order => { "contract_number" => "invalid value" }}, valid_session
        assigns(:order).should be_a_new(Order)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order" do
        ...
        Order.any_instance.should_receive(:update).with({ "contract_number" => "1" })
        put :update, {:id => order.to_param, :order => { "contract_number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the order as @order" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Order.any_instance.stub(:save).and_return(false)
        put :update, {:id => order.to_param, :order => { "contract_number" => "invalid value" }}, valid_session
        assigns(:order).should eq(order)
      end
